...
var EditarServicioComponent = /** @class */ (function () {
    function EditarServicioComponent() {
    ...
    EditarServicioComponent.prototype.ngOnInit = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    EditarServicioComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    EditarServicioComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    EditarServicioComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected() ?
            this.selection.clear() :
            this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
    };
    EditarServicioComponent.prototype.checkboxLabel = function (row) {
        if (!row) {
    ...
    return EditarServicioComponent;
}());
...
var EditarVehiculoComponent = /** @class */ (function () {
    function EditarVehiculoComponent() {
        this.displayedColumns = ['vehiculos', 'precio', 'select'];
        this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](ELEMENT_DATA);
        this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_2__["SelectionModel"](true, []);
    }
    EditarVehiculoComponent.prototype.ngOnInit = function () {
        this.dataSource.paginator = this.paginator;
        this.dataSource.sort = this.sort;
    };
    EditarVehiculoComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    EditarVehiculoComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    EditarVehiculoComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected() ?
            this.selection.clear() :
            this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
    };
    EditarVehiculoComponent.prototype.checkboxLabel = function (row) {
        if (!row) {
            return (this.isAllSelected() ? 'select' : 'deselect') + " all";
        }
        return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.vehiculos + 1);
    ...
    return EditarVehiculoComponent;
}());
...
var VehiculosIngresadosComponent = /** @class */ (function () {
    function VehiculosIngresadosComponent(NgZone, router, facturaService) {
        var _this = this;
        this.NgZone = NgZone;
        this.router = router;
        ...
        this.facturaService.getAllFactura()
            ...
            _this.resultado = res;
            for (var index = 0; index < _this.resultado.length; index++) {
                var estados = "";
                switch (_this.resultado[index].TIPO_ESTADO_ID_TIPO_ESTADO) {
                    case 2:
                        estados = "En proceso";
                        break;
                    case 3:
                ...
                _this.ELEMENT_DATA.push({
                    placa: "Placa: " + _this.resultado[index].PLACA,
                    estado: estados,
                    turno: _this.resultado[index].TURNO
                });
            }
            _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.ELEMENT_DATA);
            _this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_2__["SelectionModel"](true, []);
            _this.dataSource.paginator = _this.paginator;
            _this.dataSource.sort = _this.sort;
        }, function (err) {
        });
    }
    VehiculosIngresadosComponent.prototype.ngOnInit = function () {
    };
    VehiculosIngresadosComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    VehiculosIngresadosComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    VehiculosIngresadosComponent.prototype.masterToggle = function () {
        var _this = this;
        this.isAllSelected() ?
            this.selection.clear() :
            this.dataSource.data.forEach(function (row) { return _this.selection.select(row); });
    };
    VehiculosIngresadosComponent.prototype.checkboxLabel = function (row) {
        if (!row) {
            return (this.isAllSelected() ? 'select' : 'deselect') + " all";
        }
        return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.placa + 1);
    };
    VehiculosIngresadosComponent.prototype.consultar = function (row) {
        console.log(row.placa);
        localStorage.setItem('Turno', row.turno.toString());
        this.router.navigateByUrl('/Liquidacion');
    };
    VehiculosIngresadosComponent.prototype.eliminar = function (row) {
        var _this = this;
    ...
    VehiculosIngresadosComponent.ctorParameters = function () { return [
    ...
    return VehiculosIngresadosComponent;
}());
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.userService.getOneUser(this.usuario.USUARIO)
            .subscribe(function (res) {
            _this.usuarioObtenido = res;
            console.log(_this.usuarioObtenido);
            if (_this.usuarioObtenido.PASSWORD == _this.usuario.PASSWORD) {
                _this.router.navigateByUrl('/registroVehiculo');
                localStorage.setItem('usuario', JSON.stringify(_this.usuarioObtenido));
                var usuarioS = JSON.parse(localStorage.getItem('usuario'));
                return "Se logea";
            }
            else {
...
var LiquidacionComponent = /** @class */ (function () {
    function LiquidacionComponent(router, DetalleFacturaService, facturaService) {
        var _this = this;
        this.router = router;
        ...
        facturaService.getOneFactura(Number.parseInt(Turno))
            ...
            if (_this.factura.ID_DESCUENTOS == 0) {
                _this.descuento = " No Aplica";
            }
            else {
                _this.descuento = _this.factura.PORCENTAJE_DESCUENTO;
            }
            var date = new Date(_this.factura.FECHA_ENTRADA);
            _this.fecha = date.getDay() + "/" + (date.getMonth() + 1) + "/" + date.getFullYear() + " - " + date.getHours() + ":" + date.getMinutes();
            DetalleFacturaService.getAll(Number.parseInt(_this.factura.ID_FACTURA))
                .subscribe(function (res) {
                _this.resultado = res;
                for (var index = 0; index < _this.resultado.length; index++) {
                    _this.DataElement.push({
                        NR: index + 1,
                        Nombre: _this.resultado[index].NOMBRE_SERVICIO,
                        precio: _this.resultado[index].VALOR
                    });
                }
                _this.displayedColumns = ['NR', 'Nombre', 'precio'];
                _this.dataSource = _this.DataElement;
                _this.services = _this.getServices();
                _this.totalCost = _this.getTotalCost();
            });
        });
    }
    LiquidacionComponent.prototype.ngOnInit = function () {
    };
    LiquidacionComponent.prototype.getServices = function () {
        return this.dataSource.map(function (t) { return t.NR; }).length;
    };
    LiquidacionComponent.prototype.getTotalCost = function () {
        return this.dataSource.map(function (t) { return t.precio; }).reduce(function (acc, value) { return acc + value; }, 0);
    };
    LiquidacionComponent.prototype.actualizarFactura = function (numero) {
        var _this = this;
        var texto;
        if (numero == 3) {
        ...
        if (mensaje) {
            ...
            this.facturaService.updateFactura(this.factura.ID_FACTURA, this.facturaUpdate)
                .subscribe(function (res) {
                console.log(res);
                _this.router.navigateByUrl('/vehiculosIngresados');
            });
        }
    };
    LiquidacionComponent.ctorParameters = function () { return [
...
var RegistrarEntradaServitecaComponent = /** @class */ (function () {
    function RegistrarEntradaServitecaComponent(router, DetalleFacturaService, FacturaService, DescuentoService, servicioVehiculoRegistrarEntradaService) {
        var _this = this;
        this.router = router;
        this.DetalleFacturaService = DetalleFacturaService;
        this.FacturaService = FacturaService;
        ...
        this.servicioVehiculoRegistrarEntradaService.getOneClienteVehiculo(datosFactura.tipoVehiculo)
            ...
            for (var index = 0; index < _this.resultado.length; index++) {
                _this.ELEMENT_DATA.push({
                    servicios: _this.resultado[index].NOMBRE_SERVICIO,
                    precio: _this.resultado[index].VALOR,
                    id: _this.resultado[index].ID_SERVICIOS_VEHICULO
                });
            }
            _this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](_this.ELEMENT_DATA);
            _this.selection = new _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_2__["SelectionModel"](true, []);
    ...
    RegistrarEntradaServitecaComponent.prototype.ngOnInit = function () {
        console.log();
    };
    RegistrarEntradaServitecaComponent.prototype.applyFilter = function (filterValue) {
        this.dataSource.filter = filterValue.trim().toLowerCase();
        if (this.dataSource.paginator) {
            this.dataSource.paginator.firstPage();
        }
    };
    RegistrarEntradaServitecaComponent.prototype.isAllSelected = function () {
        var numSelected = this.selection.selected.length;
        var numRows = this.dataSource.data.length;
        return numSelected === numRows;
    };
    RegistrarEntradaServitecaComponent.prototype.masterToggle = function () {
        var _this = this;
        this.precios = 0;
        this.encendidos = 0;
        if (!this.isAllSelected()) {
            for (var index = 0; index < this.resultado.length; index++) {
    ...
    RegistrarEntradaServitecaComponent.prototype.checkboxLabel = function (row) {
        if (!row) {
            return (this.isAllSelected() ? 'select' : 'deselect') + " all";
        }
        return (this.selection.isSelected(row) ? 'deselect' : 'select') + " row " + (row.servicios + 1);
    };
    RegistrarEntradaServitecaComponent.prototype.registrarFactura = function () {
        var _this = this;
        ...
        this.FacturaService.createFactura(this.factura)
            .subscribe(function (res) {
            console.log(res);
            _this.FacturaService.getOneFactura(Number.parseInt(_this.factura.TURNO))
                .subscribe(function (res) {
                _this.facturaObtenida = res;
                _this.asignarServicios();
            });
        });
        console.log(this.factura);
    };
    RegistrarEntradaServitecaComponent.prototype.leer = function (row) {
    ...
    RegistrarEntradaServitecaComponent.prototype.calcularPrecio = function (precio, numero) {
        var _this = this;
        var porcentajeDescuento = 0;
        this.descuento.forEach(function (descuento) {
            if (numero >= descuento.CANTIDAD_SERVICIOS) {
                _this.IDdescuento = descuento.ID_DESCUENTOS;
    ...
    RegistrarEntradaServitecaComponent.prototype.generarTurno = function (Dates) {
        var fecha = Dates.getFullYear() + "" + Dates.getMonth() + "" + Dates.getHours() + "" + Dates.getMinutes() + "" + Dates.getSeconds();
        return fecha;
    };
    RegistrarEntradaServitecaComponent.prototype.asignarServicios = function () {
        var _this = this;
        ...
        this.dataSource.data.forEach(function (row) {
            if (_this.selection.isSelected(row)) {
                console.log(_this.selection.isSelected(row));
                console.log(row.id);
                _this.detalle.SERVICIOS_VEHICULO_ID_SERVICIOS_VEHICULO = row.id;
                _this.DetalleFacturaService.createDetalleFactura(_this.detalle)
                    .subscribe(function (res) {
                    console.log(res);
                });
            }
    ...
    RegistrarEntradaServitecaComponent.ctorParameters = function () { return [
    ...
    return RegistrarEntradaServitecaComponent;
}());
...
var RegistroVehiculoComponent = /** @class */ (function () {
    function RegistroVehiculoComponent(facturaService, tipoVehiculoService, VehiculoService, clienteService, clienteVehiculoService, router) {
        var _this = this;
        this.facturaService = facturaService;
        ...
        this.tipoVehiculoService.getAll()
            .subscribe(function (res) {
            var e_1, _a;
            _this.tipoVehiculos = res;
            console.log(_this.tipoVehiculos);
            try {
                for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](_this.tipoVehiculos), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var vehiculo = _c.value;
    ...
    RegistroVehiculoComponent.prototype.ngOnInit = function () {
    };
    RegistroVehiculoComponent.prototype.almacenarDatosFactura = function () {
    ...
    RegistroVehiculoComponent.prototype.registrarVehiculo = function () {
        var _this = this;
        if (this.vehiculo.ID_VEHICULO == 0) {
            console.log("creo vehiculo");
            this.VehiculoService.createVehiculo(this.vehiculo)
                .subscribe(function (res) {
                _this.VehiculoService.getOneVehiculo(_this.vehiculo.PLACA)
                    .subscribe(function (res) {
                    console.log("Consulto el vehiculo");
                    _this.vehiculoObtenido = res;
                    _this.vehiculo = _this.vehiculoObtenido;
                    _this.vehiculObtenido = true;
                    if (_this.cliente.ID_CLIENTE == 0 && _this.stateCtrl == true) {
                        _this.crearCliente();
                    }
                    else if (_this.dueno == true) {
                        _this.crearClienteXVehiculo();
                    }
                    else {
                        _this.almacenarDatosFactura();
                        _this.router.navigateByUrl('/registrarEntrada');
                    }
                }, function (err) {
                });
            });
    ...
    RegistroVehiculoComponent.prototype.buscarVehiculo = function () {
        var _this = this;
        this.facturaService.getDisponible(this.vehiculo.PLACA)
            ...
            _this.VehiculoService.getOneVehiculo(_this.vehiculo.PLACA)
                ...
                _this.vehiculObtenido = false;
                _this.vehiculo.ID_VEHICULO = 0;
            });
        });
    };
    RegistroVehiculoComponent.prototype.buscarCliente = function () {
        var _this = this;
        ...
        if (this.stateCtrl == true) {
            ...
            this.clienteService.getOneCliente(this.cliente.CEDULA)
                .subscribe(function (res) {
                _this.clienteObtenido = res;
                _this.cliente = _this.clienteObtenido;
                _this.clienteobtenido = true;
            });
        }
    };
    RegistroVehiculoComponent.prototype.crearCliente = function () {
        var _this = this;
        console.log(this.cliente.CEDULA);
        console.log("creo cliente");
        this.clienteService.createCliente(this.cliente)
            .subscribe(function (res) {
            _this.clienteService.getOneCliente(_this.cliente.CEDULA)
                .subscribe(function (res) {
                _this.clienteObtenido = res;
                _this.cliente = _this.clienteObtenido;
                _this.clienteobtenido = true;
    ...
    RegistroVehiculoComponent.prototype.crearClienteXVehiculo = function () {
        var _this = this;
        ...
        this.clienteVehiculoService.getOneClienteVehiculo(this.vehiculo.ID_VEHICULO)
            .subscribe(function (res) {
            _this.clientexVehiculo = res;
            _this.clienteXVehiculo.ID_CLIENTE_VEHICULO = _this.clientexVehiculo.ID_CLIENTE_VEHICULO;
            if (_this.clienteXVehiculo.CLIENTE_ID_CLIENTE != _this.cliente.ID_CLIENTE) {
                _this.clienteVehiculoService.updateClienteVehiculo(_this.clienteXVehiculo.ID_CLIENTE_VEHICULO, _this.clienteXVehiculo)
                    .subscribe(function (res) {
                    _this.almacenarDatosFactura();
                    _this.router.navigateByUrl('/registrarEntrada');
                });
            ...
            console.log("entro");
            _this.clienteVehiculoService.createClienteVehiculo(_this.clienteXVehiculo)
                .subscribe(function (res) {
                _this.almacenarDatosFactura();
                _this.router.navigateByUrl('/registrarEntrada');
            });
    ...
    RegistroVehiculoComponent.ctorParameters = function () { return [
        { type: _services_factura_service__WEBPACK_IMPORTED_MODULE_6__["FacturaService"] },
...
var PantallaInicioComponent = /** @class */ (function () {
    function PantallaInicioComponent() {
    }
    PantallaInicioComponent.prototype.ngOnInit = function () {
    ...
    return PantallaInicioComponent;
}());
...
var Reportes = /** @class */ (function () {
    ...
    Reportes.prototype.ngOnInit = function () {
    };
...
var ClienteVehiculoService = /** @class */ (function () {
    function ClienteVehiculoService(http) {
        this.http = http;
        this.API_URI = 'http://localhost:3000/api';
    }
    ClienteVehiculoService.prototype.getOneClienteVehiculo = function (ID) {
        return this.http.get(this.API_URI + "/clienteVehiculo/" + ID);
    };
    ClienteVehiculoService.prototype.createClienteVehiculo = function (cliente) {
        return this.http.post(this.API_URI + "/clienteVehiculo", cliente);
    };
    ClienteVehiculoService.prototype.updateClienteVehiculo = function (ID, cliente) {
        return this.http.put(this.API_URI + "/clienteVehiculo/" + ID, cliente);
    };
    ClienteVehiculoService.ctorParameters = function () { return [
...
var ClienteService = /** @class */ (function () {
    ...
    ClienteService.prototype.getOneCliente = function (ID) {
    ...
    ClienteService.prototype.updateCliente = function (ID, cliente) {
...
var DescuentoService = /** @class */ (function () {
    function DescuentoService(http) {
        this.http = http;
        this.API_URI = 'http://localhost:3000/api';
    }
    DescuentoService.prototype.getAll = function () {
        return this.http.get(this.API_URI + "/descuento");
    };
    DescuentoService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var DetalleFacturaService = /** @class */ (function () {
    function DetalleFacturaService(http) {
        this.http = http;
        this.API_URI = 'http://localhost:3000/api';
    }
    DetalleFacturaService.prototype.getAll = function (ID) {
        return this.http.get(this.API_URI + "/detalleFactura/" + ID);
    };
    DetalleFacturaService.prototype.createDetalleFactura = function (detalleFactura) {
        return this.http.post(this.API_URI + "/detalleFactura", detalleFactura);
    };
    DetalleFacturaService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var FacturaService = /** @class */ (function () {
    ...
    FacturaService.prototype.getOneFactura = function (ID) {
        return this.http.get(this.API_URI + "/factura/" + ID);
    };
    FacturaService.prototype.getAllFactura = function () {
        return this.http.get(this.API_URI + "/factura");
    };
    FacturaService.prototype.createFactura = function (factura) {
        return this.http.post(this.API_URI + "/factura", factura);
    };
    FacturaService.prototype.updateFactura = function (ID, factura) {
        console.log(factura);
        return this.http.put(this.API_URI + "/factura/" + ID, factura);
    };
    FacturaService.prototype.deleteFactura = function (TURNO) {
        return this.http.delete(this.API_URI + "/factura/" + TURNO);
    };
    FacturaService.prototype.getDisponible = function (PLACA) {
...
var servicioVehiculoRegistrarEntradaService = /** @class */ (function () {
    function servicioVehiculoRegistrarEntradaService(http) {
        this.http = http;
        this.API_URI = 'http://localhost:3000/api';
    }
    servicioVehiculoRegistrarEntradaService.prototype.getOneClienteVehiculo = function (ID) {
        return this.http.get(this.API_URI + "/servicioVehiculo/" + ID);
    };
    servicioVehiculoRegistrarEntradaService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
    ...
    return servicioVehiculoRegistrarEntradaService;
}());
...
var TipoVehiculoService = /** @class */ (function () {
    ...
    TipoVehiculoService.prototype.getAll = function () {
        return this.http.get(this.API_URI + "/tipoVehiculo");
    };
    TipoVehiculoService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
    ]; };
...
var UsuariosService = /** @class */ (function () {
    ...
    UsuariosService.prototype.getOneUser = function (USUARIO) {
...
var VehiculoService = /** @class */ (function () {
    ...
    VehiculoService.prototype.getOneVehiculo = function (PLACA) {
        return this.http.get(this.API_URI + "/vehiculo/" + PLACA);
    };
    VehiculoService.prototype.createVehiculo = function (vehiculo) {
